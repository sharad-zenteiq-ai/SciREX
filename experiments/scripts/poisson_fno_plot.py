"""Train FNO2D and plot results (prediction vs truth)."""
import os
import jax
...
def main():
    ...
    losses = []
    print("Starting training (plotting example)...")
    ...
    axes[0, 1].set_title("FNO prediction u_pred")
    ...
    fig_path = os.path.join(out_dir, "poisson_fno_results.png")
